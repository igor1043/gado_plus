...
class AnimaisFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        adapter.setOnClickListener { animal ->
            ...
            intent.putExtra(AnimaisAddEditActivity.EXTRA_NOME, animal.nBrincoIdentificador)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && (requestCode == ADD_REQUEST || requestCode == EDIT_REQUEST)) {
            val animal = Animal()
            assert(data != null)
            animal.nBrincoIdentificador = data!!.getStringExtra(AnimaisAddEditActivity.EXTRA_NOME)
